...
$GLOBALS['auth_posts'] = [101 => 'crm_client', 102 => 'crm_client', 103 => 'crm_client', 104 => 'crm_client', 105 => 'crm_client', 200 => 'post'];
$GLOBALS['auth_meta'] = [
...
auth_expect('empty', peracrm_get_client_access_scope(8)['type'], 'empty employee scope is explicit');
