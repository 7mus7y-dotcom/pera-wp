...
require_once PERACRM_PATH . '/includes/routing.php';
require_once PERACRM_PATH . '/includes/frontend/data.php';
require_once PERACRM_PATH . '/includes/frontend/client-view.php';
require_once PERACRM_PATH . '/includes/frontend/push.php';
