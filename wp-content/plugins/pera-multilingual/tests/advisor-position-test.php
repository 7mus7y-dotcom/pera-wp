...
function get_field( $name, $id, $formatted = true ) { return $GLOBALS['advisor_meta'][ $name ]; }
...
advisor_expect( 0, substr_count( implode( ',', $fields->approved( 'property' ) ), 'position' ), 'position is not duplicated in the Property contract' );
