...
final class Pera_ML_Plugin {
	private static $instance; private $registry; private $storage; private $status; private $router; private $content; private $seo; private $translator; private $fields; private $vocabulary; private $ajax;
