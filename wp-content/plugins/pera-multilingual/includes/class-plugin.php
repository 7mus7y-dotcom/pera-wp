...
final class Pera_ML_Plugin {
	private static $instance; private $registry; private $storage; private $router; private $content; private $seo; private $translator;
	...
	public function boot() { $this->router->hooks(); $this->content->hooks(); $this->seo->hooks(); if ( is_admin() ) ( new Pera_ML_Admin( $this->registry ) )->hooks(); }
