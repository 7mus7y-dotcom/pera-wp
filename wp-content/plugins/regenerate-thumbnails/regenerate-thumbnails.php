	...
	public function regenerate_interface() {
		...
		if ( version_compare( $wp_version, '4.7', '<' ) ) {
			...
			<div id="regenerate-thumbnails-app">
				...
				<div id="regenerate-thumbnails-diagnostics" class="notice notice-info" style="margin: 10px 0; display: none;">
					<p><strong>Diagnostic status:</strong> <span id="regenerate-thumbnails-diagnostics-text"><?php esc_html_e( 'Loading…', 'regenerate-thumbnails' ); ?></span></p>
				</div>
