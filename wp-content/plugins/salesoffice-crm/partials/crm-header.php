...
$sections = array(
	...
	'clients'  => array(
		...
		'url'   => home_url( '/so/crm/clients/' ),
	),
	'tasks'    => array(
		'label' => __( 'Tasks', 'hello-elementor-child' ),
		'url'   => home_url( '/so/crm/tasks/' ),
	),
	'pipeline' => array(
		'label' => __( 'Pipeline', 'hello-elementor-child' ),
		'url'   => home_url( '/so/crm/pipeline/' ),
	),
);
?>
<section class="hero hero--left hero--fit" id="crm-hero">
  <div class="hero-content container">
    ...
    <div class="hero-actions">
      <a class="btn btn--solid btn--green" href="<?php echo esc_url( home_url( '/so/crm/new/' ) ); ?>"><?php echo esc_html__( 'Create lead', 'hello-elementor-child' ); ?></a>
    </div>
    ...
    <form method="get" action="<?php echo esc_url( home_url( '/so/crm/clients/' ) ); ?>" class="crm-client-hero-filters">
      ...
      <div class="crm-client-hero-filters-grid">
        ...
        <div class="crm-client-hero-filter-actions">
          ...
          <a class="btn btn--ghost btn--white" href="<?php echo esc_url( home_url( '/so/crm/clients/' ) ); ?>"><?php esc_html_e( 'Clear', 'hello-elementor-child' ); ?></a>
        </div>
      </div>
    </form>
    <?php endif; ?>
