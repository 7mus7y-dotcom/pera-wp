...
$heading = isset( $cta_args['heading'] ) && is_scalar( $cta_args['heading'] ) && trim( (string) $cta_args['heading'] ) !== ''
	...
	: pera_ml_ui( 'Talk to Pera about your Istanbul plans', 'theme.contact_cta.default_heading' );

$text = isset( $cta_args['text'] ) && is_scalar( $cta_args['text'] ) && trim( (string) $cta_args['text'] ) !== ''
	? (string) $cta_args['text']
	: pera_ml_ui( 'Whether you’re buying, selling, or renting in Istanbul, our team can walk you through the numbers, the legal steps, and the neighbourhoods that fit your strategy.', 'theme.contact_cta.default_intro' );
...
$whatsapp_message = isset( $cta_args['whatsapp_message'] ) && is_scalar( $cta_args['whatsapp_message'] ) && trim( (string) $cta_args['whatsapp_message'] ) !== ''
	...
	: pera_ml_ui( "Hello Pera Property, I'd like to discuss Istanbul real estate.", 'theme.contact_cta.whatsapp_message' );
